...
\begin{acronym}[WHILE]
	...
	\acro{muREC}[\ensuremath{\mu\mathrm{REC}}]{Menge der \ensuremath{\mu}-rekursiven Terme}
	...
	\acro{PREC}[\ensuremath{\operatorname{PREC}}]{Menge der primitiv rekursiven Terme}
