...
\includeonly{1-Vorspann_Sprachen,2-Regulaere_Sprachen_und_endliche_Automaten,3-Grammatiken_und_kontextfreie_Sprachen,4-Kellerautomaten,8-Rekursive_Funktionen}
...
% References
% A partial PDF cannot contain destinations from omitted chapters. Load
% hyperref in draft mode for partial builds; full builds retain hyperlinks.
\makeatletter
\if@partsw
...
% Hyperref's default theorem anchors omit the parent counter even though the
% printed theorem numbers include it. Make PDF destinations unique by section
% and subsection.
\renewcommand*{\theHBeobachtung}{\thesection.\arabic{subsection}.\arabic{Beobachtung}}
\renewcommand*{\theHBsp}{\thesection.\arabic{subsection}.\arabic{Bsp}}
\renewcommand*{\theHDef}{\thesection.\arabic{subsection}.\arabic{Def}}
\renewcommand*{\theHsubDef}{\theHDef.\arabic{subDef}}
\renewcommand*{\theHSatz}{\thesection.\arabic{subsection}.\arabic{Satz}}
\renewcommand*{\theHlemma}{\thesection.\arabic{subsection}.\arabic{Satz}}
\renewcommand*{\theHKorollar}{\thesection.\arabic{subsection}.\arabic{Satz}}
\let\proof=\relax
...
\begin{titlepage}
	...
	\textbf{\large\textsf{Formale Sprachen und Berechenbarkeit}}
...
{\LARGE \textsf{Peter Thiemann}}

\textsf{\footnotesize thiemann@informatik.uni-freiburg.de}
...
Im SS 2026 wurde die Vorlesung von Prof. Dr. Peter Thiemann gehalten und das Skript wieder  überarbeitet.\\
\url{https://proglang.github.io/teaching/26ss/ti.html}
...
\vspace{\baselineskip}
\ifthenelse{\boolean{fullversion}}{\tableofcontents}{}
...
\begin{acronym}[WHILE]
	...
	\acro{muREC}[\ensuremath{\mu\mathrm{REC}}]{Menge der \ensuremath{\mu}-rekursiven Funktionen}
	...
	\acro{PREC}[\ensuremath{\operatorname{PREC}}]{Menge der primitiv rekursiven Funktionen}
	...
	\acro{URM}{unbeschränkte Registermaschine}
	\acro{WHILE}{Menge der WHILE-Programme}
\end{acronym}
\listoffixmes
