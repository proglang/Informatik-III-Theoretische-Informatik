...
\begin{itemize}
	...
	\end{align*}
	\begin{align*}
		S &\vdash^* \pmqty{(q_0,a_1)\\a_1}\pmqty{a_2\\a_2}\dots\pmqty{a_n\\a_n}\\
		&\phantom{{}\vdash^*{}}\ \acs*{TM}\ \,\dots\\
		&\vdash^* \pmqty{x_1\\a_1}\dots\pmqty{(q',x_i)\\a_i}\dots\pmqty{x_n\\a_n}\\
		&\vdash^* a_1\dots a_i\dots a_n
	\end{align*}
