...
\subsection{Worproblem und Leerheitsproblem für kontextfreie Sprachen}
...
$$M_{ij} = \{ A \in N \mid A \stackrel{*}{\vdash} a_i\dots a_j \}$$
	\begin{align*}
...
% 			M =
		...
		\cline{2-9}
			\multicolumn{1}{c}{a} & & A       & \bullet & \bullet & {X} ~\text{\tiny 4}& {Z} ~\text{\tiny 5}& \bullet & \bullet \\
		\cline{3-9}
			     \multicolumn{1}{c}{} & \multicolumn{1}{c}{a} &    & A       & X ~\text{\tiny 2}      & Z     ~\text{\tiny 3}  & \bullet & \bullet & \bullet \\
		\cline{4-9}
			          \multicolumn{2}{c}{} & \multicolumn{1}{c}{a} &         & B       & \bullet & \bullet & \bullet & \bullet \\
		\cline{5-9}
			               \multicolumn{3}{c}{} & \multicolumn{1}{c}{b} &              & B       & \bullet & \bullet & \bullet \\
		\cline{6-9}
			                    \multicolumn{4}{c}{} & \multicolumn{1}{c}{b} &                   & B & \bullet & \bullet \\
		\cline{7-9}
			                         \multicolumn{5}{c}{} & \multicolumn{1}{c}{b} &                        & C,Y     & Y ~\text{\tiny 1}      \\
		\cline{8-9}
			                              \multicolumn{6}{c}{} & \multicolumn{1}{c}{c} &                              & C,Y     \\
		\cline{9-9}
		\multicolumn{7}{c}{} & \multicolumn{1}{c}{c} & \multicolumn{1}{c}{}
		\end{tabular}
  \end{center}
\end{Bsp}
...
\begin{proof}
    ...
    Wir können $M$ induktiv berechnen.
	\begin{align*}
