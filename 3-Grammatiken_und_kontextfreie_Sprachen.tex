...
\end{itemize}
\begin{align*}
	\mathcal{G}: S &\-> 1S0S \mid 0S1S \mid \Eps\\
...
\begin{alignat*}{2}
	&\text{Länge }0:\quad& \Eps &\in L
		\quad,\quad \Eps \in L(\mathcal{G})
		\quad,\quad S \-> \Eps\\
...
\begin{Def}[name={[Ableitungsbaum]}] Sei $\mathcal{G}$ \ac{CFG}.\\
	...
	\item Jedes Blatt ist mit $x\in\Sigma\cup\{\Eps\}$ markiert.
	...
	\textbf{Oder:} $n=1$, die Produktion ist $A\->\Eps$ und $k_1$ ist mit $\Eps$ markiert.
	\end{itemize}
