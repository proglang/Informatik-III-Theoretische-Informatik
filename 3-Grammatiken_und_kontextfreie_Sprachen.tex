...
% 			M =
		...
		\cline{3-9}
			     \multicolumn{2}{c}{} & a     & A       & X ~\text{\tiny 2}      & Z     ~\text{\tiny 3}  & \bullet & \bullet & \bullet \\
		\cline{4-9}
			          \multicolumn{3}{c}{} & a          & B       & \bullet & \bullet & \bullet & \bullet \\
		\cline{5-9}
			               \multicolumn{4}{c}{} & b               & B       & \bullet & \bullet & \bullet \\
		\cline{6-9}
			                    \multicolumn{5}{c}{} & b                    & B & \bullet & \bullet \\
		\cline{7-9}
			                         \multicolumn{6}{c}{} & b                         & C,Y     & Y ~\text{\tiny 1}      \\
		\cline{8-9}
			                              \multicolumn{7}{c}{} & c                               & C,Y     \\
		\cline{9-9}
		\multicolumn{8}{c}{} & \multicolumn{1}{c}{c}
		\end{tabular}
  \end{center}
\end{Bsp}
