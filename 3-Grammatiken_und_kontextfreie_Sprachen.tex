...
\begin{Bsp}\label{bsp:3.palindromeGrammar}
...
\begin{Bsp}Für die Grammatik aus \autoref{bsp:3.palindromeGrammar} gilt: $01010\in L(\mathcal{G})$.
$$ S 
\vdash_\mathcal{G} 0S0
\vdash_\mathcal{G} 01S10
\vdash_\mathcal{G} 01010
$$
\end{Bsp}
