...
\begin{Korollar}\label{kor:6.11_alt}
...
\begin{Bemerkung}
	Informelles Schema für Reduktionsbeweise:
	%
	\begin{enumerate}
		...
		\item angeben, dass und warum $f$ total und berechenbar ist
...
\begin{Bemerkung}
	...
	\begin{align*}
		H_{\forall w} = \{\godel{\M} \mid \text{$\M$ angesetzt auf ein beliebiges Wort $w \in \Sigma^*$ hält}\}
		\qedhere
	\end{align*}
\end{Bemerkung}
