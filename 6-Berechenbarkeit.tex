...
\begin{proof}
  ...
  die in der Eingabe das erste Vorkommen eine $\#$ Zeichens sucht und
  ...
  Wie könnten z.B. die durch das folgende Flussdiagramm beschriebene TM nehmen, denn diese hält auf keiner Eingabe:
  \begin{tikzpicture}
