...
\end{tikzpicture}
	\caption{Illustration des Diagonalargumentens beim Beweis des Satzes von Cantor}
\end{figure}
...
\end{proof}
 ...
 \begin{figure}[H]\centering
  ...
  Die TM $\M_{\chi_K}$ verhält sich wie $\M_\text{€}$ aber statt zu akzeptieren (bzw. nicht zu akzeptieren) schreibt diese 1 (bzw. 0) auf das Band und hält.}
  \label{fig:Mevil}
 \end{figure}
...
\end{tikzpicture}
	\caption{Illustration des Diagonalargumentens beim Beweis der Unentscheidbarkeit des speziellen Halteproblems}
\end{figure}
