...
\begin{Bemerkung}
 Zum Verständnis dieses Kapitels ist es nötig sich mit den Begriffen Injektiv, Surjektiv und Bijektiv vertraut zu machen.
...
\subsubsection{Abzählbarkeit, Überabzählbarkeit}
In der Literatur wir die Existenz nicht berechenbarer Funktionen manchmal in einem allgemeineren Kontext gezeigt.
...
\begin{itemize}
 ...
 \item \emph{überabzählbar}, wenn es keine bijektive Abbildung zwischen $X$ und $\N$ gibt.
\end{itemize}
\end{Def}
...
\begin{itemize}
 ...
 \item Es gibt keine surjektive Abbildung von einer abzählbaren in eine überabzählbare Menge.
\end{itemize}
