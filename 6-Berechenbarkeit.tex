\section[Berechenbarkeit]{Berechenbarkeit\datenote{08.01.16}}
...
\datenote{14.01.16} % Danke @ Lars Nitzke
\vspace{1em}
...
\datenote{20.01.15} % Latex-Qelle von M. Geffken
...
\underline{Gesucht:} Lösung des \acsu{CP} mit $i_1=1$
...
\begin{lemma}[name={[H $\preceq$ \ac{MPCP}]}] \datenote{28.01.16}
	H $\preceq$ \ac{MPCP}
\end{lemma}
\begin{proof}
