...
Wir konstruieren einen NEA $\B_*=(\Sigma, Q, \delta_*, \qinit, \{\qinit\})$ für $L^*$, bei dem wir von jedem akzeptierenden Zustand einen $\Eps$-Übergang zum Startzustand hinzufügen und nur den Startzustand akzeptierend machen.
\[
                \delta_*(q,x) =
                        \begin{cases}
                                \delta(q,x) & q\notin F \text{ oder } x \neq \Eps\\
                                \{\qinit\} & q\in F \text{ und } x = \Eps \\
                                \{\} & q\notin F \text{ und } x = \Eps
                        \end{cases}
\]
