...
%
    \begin{Bsp*} Mustererkennung
        ...
        \begin{align*} & \Sigma^* abac \Sigma^* \\
                       \leadsto\ & (a_1 + a_2 + ...)^* abac (a_1 + a_2 + ...)^* \quad \forall a_i \in \Sigma
          \end{align*}
        \item Sei $\Sigma=\{0,1\}$. Die Sprache aller Wörter, deren $n$-letztes Symbol eine 1 ist, ist nicht regulär, denn:
        \begin{gather*}
        (0+1)^*1\underbrace{(0+1)\dots(0+1)}_{n-1}\\
        \xcancel{0^n1^n}\notin RE(\Sigma)
        \end{gather*}
        \item Ein regulärer Ausdrück für alle Wörter $w \in \{0, 1\}^*$, sodass $w \mod 3=0$:
        \[ (0+1(01^*0)^*1)^* \]
