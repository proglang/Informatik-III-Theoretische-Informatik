...
Bemerkung: Wenn $f : A \to \calP (B)$ ist, dann schreiben wir $\hat{f} : \calP (A) \to \calP (B)$ für die Fortsetzung von $f$ auf Mengen. D.h. $\hat{f} (M) = \bigcup \{ f(a) \mid a \in M \}$, falls $M \subseteq A$.
