...
\[
L_1=\{w\in\{0,1\}^*\mid w \text{ ist Bin\"arcodierung einer Primzahl}\}
\]
Ein weiteres Beispiel wäre
\[
L_2=\{w\in\{0,1\}^*\mid w \text{ die Anzahl der Einsen in $w$ ist gerade }\}
\]
...
Wir müssen zunächst verstehen was ``Binärcodierung'', ``Primzahl'' oder ``gerade Anzahl'' bedeutet und für $L_1$ und $L_2$ jeweils einen Algorithmus zur Entscheidung entwickeln.
