...
\renewcommand{\0}{\underline{\emptyset}}
\renewcommand{\1}{\underline{\Eps}}
\newcommand{\hide}[1]{}
...
Eine Umsetzung: Gib Rechner den folgenden NEA, dieser konvertiert den NEA dann in einem DEA um das Wortproblem effizient zu lösen.
  \begin{center}
                \begin{tikzpicture}[circle/.style={
                        shape=circle,
                        minimum size=0.5cm,
                        ...
                        \node [circle, double] (v4drei) at (10,1) {$q_{5}$};
                        \node [circle] (v4I) at (10,-1) {$q_{6}$};
                        \node [circle] (v4II) at (12,-1) {$q_{7}$};
                        \node [circle, double] (v4III) at (14,-1) {$q_{8}$};
                        \draw [->] (vs) edge (v0);
                ...
                \end{tikzpicture}
  \end{center}
Problem: Einen Graph als Eingabe den den Rechner zu übermitteln ist unkomfortabel oder zeitaufwändig.
...
\begin{Bsp}~
\begin{enumerate}
 \item \texttt{(A+...+Z+a+...+z+0...+9)}$^*$\texttt{(I+i)nfo(3+III)(A+...+Z+a+...+z+0...+9)}$^*$ 
 ist ein regulärer Ausdruck\footnote{Wir verwenden hier \texttt{A+...+Z} als Abkürzung für die Disjunktion aus 26 Zeichen. 
 Der reguläre Ausdruck besteht uns der Disjunktion drei Punkte kommen darin nicht vor.}
 ...
 \item $\0\1\0\1$ ist über jedem Alphabet.
