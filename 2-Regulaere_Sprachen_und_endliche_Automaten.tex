...
\begin{center}
  \includegraphics[scale=0.4]{macaron-stacks.png}
\end{center}
...
\begin{Bsp}\label{bsp:3.3}
	...
	\begin{equation*}
		L = \{ 0^n1^n \mid n\in\N \} 
	\end{equation*}
	erkennbar durch \ac{TM} die immer anhält, \emph{aber nicht} von einem \ac{DEA} [\underline{nicht} regulär] akzeptiert werden kann.
	\begin{proof}
