...
\begin{proof}[Potenzmengenkonstruktion]
        ...
        \end{align*}
        Wir wollen nun $L(\A')=L(\calN)$ zeigen. Dafür beweisen wir zunächst via Induktion über die Länge von $w$
        $$ \forall w\in\Sigma^* \forall q\in Q: q\in\tilde\delta_P(\qinit_\calP,w) \Leftrightarrow \exists \underbrace{\qinit, q_1,\ldots q_n}_{\text{Lauf}}\in Q, \text{ sodass }  n=|w| \text{ und } q_n=q$$
