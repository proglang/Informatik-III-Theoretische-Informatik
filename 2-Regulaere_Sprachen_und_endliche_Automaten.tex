...
\begin{itemize}
 ...
 \item Angenomen es gilt für alle Wörter $w\in\Sigma^*$ dass $uw\in L\Leftrightarrow vw\in L$, 
 dann wissen wir dass es eine gute Idee war den Automaten mit $u$ und $v$ in den gleichen Zustand zu führen.
\end{itemize}
Angenomen wir finden nicht nur für zwei Wörter $u,v$ ein Wort $w$ sodass die Äquivalenz $uw\in L \Leftrightarrow vw\in L$ nicht gilt
sondern wir finden soch ein $w$ für jedes Paar aus einer unendlich großen Menge von Wörtern $U$.
\begin{center}
