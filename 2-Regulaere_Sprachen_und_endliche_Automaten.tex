...
Zeige via stukturelle Induktion über den Aufbau regulärer Ausdrücke, dass $ \llbracket r \rrbracket$ regulär ist.
...
\begin{Def}
  ...
  Definiere für einen Zustand $q$ die \emph{Sprache des Zustands} $L_q=\{ w \in \Sigma^* \mid \tilde\delta(q,w)\in F \}$ als die Sprache der Wörter, die von Zustand $q$ aus in einen akzeptierenden Zustand führen.
\end{Def}
