...
Eine Relation binäre ist eine 

Eine Relation $R\subseteq X\times X$ heißt
\begin{itemize}
 \item \emph{reflexiv}, wenn $\forall x\in X$\ $(x,x)\in R$
 \item \emph{symmetrisch}, wenn $\forall x, y\in X$\ $(x,y)\in R \quad \Rightarrow\quad (y,x)\in R$
 \item \emph{transitiv}, wenn $\forall x, y, z\in X$\ $(x,y)\in R \land (y,z)\in R\quad \Rightarrow\quad (x,z)\in R$
\end{itemize}
