...
\begin{proof}[von \autoref{satz:2.rabinscott}]
        ...
        \begin{align*}
         ...
         &\<=> \exists q_f\in F : \tilde\delta_\calP(\qinit_\calP,w) = q_f\\
         &\<=> \exists q_0 \in \qinit_\calP = \{ \qinit_\A \}. \  {q_0, q_1,\ldots, q_n} \in \Run(q_0, w), \text{ sodass } q_n\in F\\
...
\subsection{\acf{PL} für reguläre Sprachen}\datenote{REVISION POINTER}
