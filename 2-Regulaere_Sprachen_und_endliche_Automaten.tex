\section[Reguläre Sprachen und endliche Automaten]{Reguläre Sprachen und endliche Automaten\draftnote{21.10.16}}
...
\label{bsp:3.1}
	\begin{equation*}
		L=\{ w\in\{0,1\}^* \mid w\text{ enthält höchstens eine 1} \} 
	\end{equation*}
	\begin{figure}[H]\centering
		\begin{tikzpicture}
			\node (start) at (-4,1.5) {};
