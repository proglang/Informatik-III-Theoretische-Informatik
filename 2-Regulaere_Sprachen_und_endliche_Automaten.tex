...
Der Potzenzmengenautomat für den NEA aus \autoref{bsp:2.zweitletztes} hat das folgende Zutandsdiagramm.
  \begin{center}
                \begin{tikzpicture}[circle/.style={
                        ...
                        \draw [->] (v3) edge [loop right] node[auto] {0} (v3);
...
\begin{proof}[von \autoref{satz:2.rabinscott}]
        ...
        \begin{eqnarray*}
                ...
                & \Leftrightarrow & \exists\underbrace{q_1q_2\ldots q_{n+1}}_{\text{Lauf}}\in Q, \text{ sodass }  n=|w'|, \exists q_0\in p, \delta(q_0,a)=q_1 \text{ und } q_{n+1}=q\\
...
Idee: Konstruiere Automaten für $L_1\cdot L_2$ durch ``Hintereinanderschalten''.

TODO Beispiel und Motivation.
