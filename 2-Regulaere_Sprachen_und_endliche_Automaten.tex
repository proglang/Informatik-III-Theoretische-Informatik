...
Eine Umsetzung: Gib Rechner den folgenden NEA ...
...
\begin{Def}[name={[Semantik eines regulären Ausdrucks]}]
        Die von einem regulären Ausdruck \emph{erzeugte Sprache} $\llbracket\cdot \rrbracket : RE(\Sigma) \-> \mathcal{P}(\Sigma^*)$ ist induktiv definiert durch
        \begin{align*}
...
\end{Def}
\begin{Bsp}
 TODO Einmal ausrechnen
\end{Bsp}
\begin{Bsp}
 TODO 1 Bekannte Sprache
\end{Bsp}
