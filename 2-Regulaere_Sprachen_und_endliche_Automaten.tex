...
\begin{Bsp} %\rlnote{Bsp.-Num. überprüfen (3.6)}
  \label{Bsp:R_m}
        ...
        \begin{description}
                ...
                \item[Beobachtung 2] $R_\A$ ist rechtskongruent. Beweis: In den Übungen
                \item[Beobachtung 3] Anzahl der Äquivalenzklassen(Index von $R_\A$)\\
                = Anzahl der Zustände, die von $\qinit$ erreichbar sind.
        \end{description}
