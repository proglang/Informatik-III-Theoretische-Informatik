...
Links: DEA $\A_1$, der Automat aus \autoref{bsp:2.zweitletztes} eingeschränkt auf die erreichbaren Zustände. Rechts: DEA $\A_2$ dessen Sprache $\{w\in\{0,1\}^*\mid \text{Anzahl $1$ in $w$ ist ungerade}\}$ ist.
  \begin{center}
                ...
                \begin{tikzpicture}[circle/.style={
                        ...
                        align=center}]
                        \node (vs) at (-1.0,1.0) {};
                        \node [circle] (v0) at (0,0) {$s_0$};
                        \node [circle, accepting] (v1) at (3,0) {$s_1$};
                        \draw [->] (vs) edge (v0);
                        \draw [->] (v0) edge [loop above] node[auto] {0} (v0);
                        \draw [->] (v1) edge [loop above] node[auto] {0} (v1);
                        \draw [->] (v0) edge [bend left=15] node[auto] {1} (v1);
                        \draw [->] (v1) edge [bend left=15] node[auto] {1} (v0);
                \end{tikzpicture}
  \end{center}
...
\datenote{10.11.17}
   \begin{center}
                \begin{tikzpicture}[circle/.style={
                        ...
                        align=center}]
                        \node (vs) at (-1.0,1.0) {};
                        \node [circle] (v0) at (0,0) {$q_0$};
                        \node [circle] (v1) at (2,-1) {$q_1$};
                        \node [circle] (v2) at (4,-1) {$q_2$};
                        \node [circle] (v3) at (3,1) {$q_3$};
                        \node [circle, double] (v4) at (6,0) {$q_4$};
                        \draw [->] (vs) edge (v0);
                        \draw [->] (v0) edge [loop above] node[auto] {$\Eps$} (v0);
                        \draw [->] (v0) edge [bend left=0] node[auto] {$\Eps$} (v1);
                        \draw [->] (v1) edge [bend left=0] node[auto] {$a$} (v2);
                        \draw [->] (v2) edge [bend left=0] node[auto] {$\Eps$} (v4);
                        \draw [->] (v0) edge [bend left=0] node[auto] {$\Eps$} (v3);
                        \draw [->] (v3) edge [bend left=0] node[auto] {$\Eps$} (v4);
                        \draw [->] (v4) edge [bend left=60] node[auto] {$\Eps$} (v1);
                \end{tikzpicture}
   \end{center}
\end{Bsp}
