...
% Compiled with pdflatex -enable-write18 -synctex=1 -interaction=nonstopmode
...
\include{2-Turing_und_Church}
\include{3-Regulaere_Sprachen_und_endliche_Automaten}
\include{4-Grammatiken_und_kontextfreie_Sprachen}
\include{5-Kellerautomaten}
