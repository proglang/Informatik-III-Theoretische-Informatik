...
Der Kellerautomat akzeptiert statt dessen wenn am Ende eines Zustandsüberganges das Eingabewort komplett gelesen 
...
Die erste Komponete des Tripels ist dabei das gelesene Zeichen der Eingabe,
...
Diese Transition sollte genau bei der Hälfte des Eingabewortes genommen werden.
In Zustand $q_1$ vergleicht der Automat sukzesive die verbleibenden Eingabesymbole mit dem Inhalt des Stapelspeicher.
Nur bei Übereinstimmung wird der Stapelspeicher bis zum Kellerbodensymbol geleert.
Falls nur noch das Kellerbodensymbol auf dem Stapelspeicher liegt kann der Automat dieses mit der $\Eps;\#;\Eps$ Transition entfernen und die Eingabe akzeptieren.

Auf Englisch heißen Kellerautomaten \emph{pushdown automata} und wir werden die Abkürzung PDA für Kellerautomaten verwenden. 
In diesem Kapitel befassen wir uns zunächst nur mit nichtdeterministischen Kellerautomaton und definieren diese formal wie folgt.
