...
\datenote{15.12.2017}
  Die Menge der kontextfreien Sprachen ist eine echte Teilmenge der Menge der kontextsensitiven Sprachen.
% 	$\mathcal{L}_2 \subsetneq \mathcal{L}_1$
\end{lemma}
\begin{proof}
	Sei $L=\{a^nb^nc^n \mid n\geq 1\}$.
	Aus \autoref{bsp:3.anbncn} wissen wir bereits dass $L$ von einer kontextsensitiven Grammatik erzeugt wird.
