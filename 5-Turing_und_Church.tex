...
\begin{Bsp*}
	Wir bestimmen die Codierung $\godel{\M_r}$ der 1-Schritt-Rechtsmaschine $\M_r$ aus \autoref{bsp:simpletms}.
	...
	Die Reihenfolge der Zustände ist hier klar, da der Startzustand (hier $q_0$) immer die Nummer 1 hat (daher hat $q_1$ hier die Nummer~2).
	...
	\begin{itemize}
		...
		$(q_0, \blank, q_1, \blank, R), (q_0, 0, q_1, 0, R), (q_0, 1, q_1, 1, R)$.
		
		\item Turingmaschine: $\godel{\M_r}$ = \\ $111 \underbrace{11\overbrace{0\,1\,0\,1\,00\,1\,0\,1\,000}^\text{erste Transition} 11 \overbrace{0\,1\,00\,1\,00\,1\,00\,1\,000}^\text{zweite Transition} 11 \overbrace{0\,1\,000\,1\,00\,1\,000\,1\,000}^\text{dritte Transition} 11}_{\godel{\delta}}111\underbrace{\,}_{\godel{F}}111$
		\qedhere
	\end{itemize}
\end{Bsp*}
